...
<script type="text/javascript" src="<?php echo e(asset('js/core/jquery.3.2.1.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')); ?>"></script>
